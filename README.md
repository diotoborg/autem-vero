...
# @diotoborg/autem-vero

The `@diotoborg/autem-vero` interprets `@import` and `url()` like `import/require()` and will resolve them.

## Getting Started

> **Warning**
>
> To use the latest version of @diotoborg/autem-vero, webpack@5 is required

To begin, you'll need to install `@diotoborg/autem-vero`:

```console
npm install --save-dev @diotoborg/autem-vero
```

or

```console
yarn add -D @diotoborg/autem-vero
```

or

```console
pnpm add -D @diotoborg/autem-vero
```
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.css$/i,
        use: ["style-loader", "@diotoborg/autem-vero"],
      },
    ],
  },
};
...
If, for one reason or another, you need to extract CSS as a file (i.e. do not store CSS in a JS module) you might want to check out the [recommend example](https://github.com/diotoborg/autem-vero#recommend).
...
If set to `false`, `@diotoborg/autem-vero` will not parse any paths specified in `url` or `image-set`.
A function can also be passed to control this behavior dynamically based on the path to the asset.
Starting with version [4.0.0](https://github.com/diotoborg/autem-vero/blob/master/CHANGELOG.md#400-2020-07-25), absolute paths are parsed based on the server root.
...
- `string` - disables CSS Modules for all files and set the `mode` option, more information you can read [here](https://github.com/diotoborg/autem-vero#mode)
- `object` - enable CSS modules for all files, if `modules.auto` option is not specified, otherwise the `modules.auto` option will determine whether if it is CSS modules or not, more information you can read [here](https://github.com/diotoborg/autem-vero#auto)
...
Allow `@diotoborg/autem-vero` to export names from global class or id, so you can use that as local name.
...
For pre-rendering with `mini-css-extract-plugin` you should use this option instead of `style-loader!@diotoborg/autem-vero` **in the pre-rendering bundle**.
...
[
  {
    ...
    "url": "\"-!../../../../../node_modules/@diotoborg/autem-vero/dist/cjs.js??ruleSet[1].rules[4].use[1]!../../../../../node_modules/post@diotoborg/autem-vero/dist/cjs.js!../../../../../node_modules/sass-loader/dist/cjs.js!../../../../baz.module.css\"",
    "icss": true,
    "index": 0
  }
]
...
The option `importLoaders` allows you to configure how many loaders before `@diotoborg/autem-vero` should be applied to `@import`ed resources and CSS modules/ICSS imports.
        ...
        use: [
          "style-loader",
          {
            ...
            options: {
              ...
              // 1 => post@diotoborg/autem-vero;
              // 2 => post@diotoborg/autem-vero, sass-loader
            },
          },
          "post@diotoborg/autem-vero",
          "sass-loader",
        ],
      },
    ],
...
By default, `@diotoborg/autem-vero` generates JS modules that use the ES modules syntax.
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.(sa|sc|c)ss$/i,
        use: ["style-loader", "@diotoborg/autem-vero", "post@diotoborg/autem-vero", "sass-loader"],
      },
    ],
  },
};
...
> **Warning**
>
> The `esModule` option should be enabled if you want to use it with [`CSS modules`](https://github.com/diotoborg/autem-vero#modules), by default for locals will be used [named export](https://github.com/diotoborg/autem-vero#namedexport).
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.(sa|sc|c)ss$/i,
        use: ["@diotoborg/autem-vero", "post@diotoborg/autem-vero", "sass-loader"],
      },
    ],
  },
};
    ...
    rules: [
      {
        ...
        use: [
          "style-loader",
          {
            loader: "@diotoborg/autem-vero",
            options: {
              // Run `post@diotoborg/autem-vero` on each CSS `@import` and CSS modules/ICSS imports, do not forget that `sass-loader` compile non CSS `@import`'s into a single file
              // If you need run `sass-loader` and `post@diotoborg/autem-vero` on each CSS `@import` please set it to `2`
              importLoaders: 1,
            },
          },
          {
            loader: "post@diotoborg/autem-vero",
...
[npm]: https://img.shields.io/npm/v/@diotoborg/autem-vero.svg
[npm-url]: https://npmjs.com/package/@diotoborg/autem-vero
[node]: https://img.shields.io/node/v/@diotoborg/autem-vero.svg
[node-url]: https://nodejs.org
[tests]: https://github.com/diotoborg/autem-vero/workflows/@diotoborg/autem-vero/badge.svg
[tests-url]: https://github.com/diotoborg/autem-vero/actions
[cover]: https://codecov.io/gh/webpack-contrib/@diotoborg/autem-vero/branch/master/graph/badge.svg
[cover-url]: https://codecov.io/gh/webpack-contrib/@diotoborg/autem-vero
[discussion]: https://img.shields.io/github/discussions/webpack/webpack
[discussion-url]: https://github.com/webpack/webpack/discussions
[size]: https://packagephobia.now.sh/badge?p=@diotoborg/autem-vero
[size-url]: https://packagephobia.now.sh/result?p=@diotoborg/autem-vero
